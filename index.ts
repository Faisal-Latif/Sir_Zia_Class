...
var faisalName:string="Hello Eric";
...
var faisalCase:string="Muhammad Burhan";
...
const author:string="Vince Lombardi";
...
const famous_person:string="Vince Lombardi"
const message:string="Winner Never Quit, Quitter Never Win"
console.log(message);
...
var strippingName:string=`Muhammad\tBurhan`;
...
let myMessage:string="My favorite number is"
...
var friendsNames:string[]=["Ali","Ahmad","Aslam","Suleman"];
...
var myCar:string[]=["red colour","best fuel average"," good Air Conditioner","excellent suspension"];
...
let dinner:string[]=["Burhan", "Rohan", "Subhan"];
for(let i:number=0;i<dinner.length;i++){
...
var places:string[]= ["Makkah ","Turkey","Iran","madina","Iraq",];
...
let cityList:string[]=["Faisalabad","Lahore","Islamabad","Karachi","peshawar"];
...
// program.
const indexArray: number[] = [1, 2, 3, 4, 5];
...
let studentpractice:string="Yes";
...
const fruits:string[]=["banaba","apple","orange","guava"];
...
var usernames: string[] = ["admin", "faisal", "ali", "burhan"]
...
let users:string[]= ["faisal","hussain","hassan", "burhan","rohan"];
...
let current_users:string[]=["asgar","akber","amer","arshad","amjad"]
...
let new_users:string[]=["asgar","akber","ahsan","essa","ibrahim"]
...
var ordinalNumber: number[] = [1, 2, 3, 4, 5, 6, 7, 8, 9]
...
var pizzas: string[] = ["chicken fajita", "home town", "malai boti"]
...
var animals: string[] = ["dog", "cow", "goat"]
...
const magicianArray:string[]=["jawad","fawad","sajjad","mujahad","karamat","salamat"]
...
const magician:string[]=["jawad","fawad","sajjad","mujahad","karamat","salamat"]
...
make_great(magician);
const newArray:string[]=["jawad","fawad","sajjad","mujahad","karamat","salamat"];
